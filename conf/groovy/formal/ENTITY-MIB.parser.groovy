/**
 * Auto-generated from ENTITY-MIB.mib
 * Generated: 2026-08-25T16:46:59.291869400
 * Traps/Notifications (1): entConfigChange
 *
 * Mapping rules:
...
// Description: An entConfigChange notification is generated when the value of entLastChangeTime changes. It can be utilized by an NMS to trigger logical/physical entity table maintenance polls. An agent should not g...
trapMap["1.3.6.1.2.1.47.2.0.1"] = [
...
def agent = ""
// --- Trap: entConfigChange (OID 1.3.6.1.2.1.47.2.1) ---
if (trapRuleName == "entConfigChange") {
    event.setAlertGroup("Entity Config Change")
    def alertKey = ""
    event.setAlertKey(alertKey)
    def summary = "Ent Config Change"
