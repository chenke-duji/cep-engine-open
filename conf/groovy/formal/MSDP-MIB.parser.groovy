/**
 * Auto-generated from MSDP-MIB.mib
 * Generated: 2026-08-24T18:28:31.888825100
 * Traps/Notifications (2): msdpEstablished, msdpBackwardTransition
 *
 * Mapping rules:
...
// OID: 1.3.6.1.3.92.1.1.0.1
// Fields: msdpPeerFsmEstablishedTransitions
// Description: The MSDP Established event is generated when the MSDP FSM enters the ESTABLISHED state.
trapMap["1.3.6.1.3.92.1.1.0.1"] = [
    name: "msdpEstablished",
    fields: ["msdpPeerFsmEstablishedTransitions"],
    fieldOids: ["msdpPeerFsmEstablishedTransitions": "1.3.6.1.3.92.1.1.5.1.15"]
]

// --- msdpBackwardTransition (NOTIFICATION-TYPE) ---
// OID: 1.3.6.1.3.92.1.1.0.2
// Fields: msdpPeerState
...
trapMap["1.3.6.1.3.92.1.1.0.2"] = [
    name: "msdpBackwardTransition",
    fields: ["msdpPeerState"],
    fieldOids: ["msdpPeerState": "1.3.6.1.3.92.1.1.5.1.3"]
]
